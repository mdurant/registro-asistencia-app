// SQL schema — mirror of database/schema.sql for runtime migrations
...
INSERT OR IGNORE INTO supermarkets (id, name, commune, address, latitude, longitude, geofence_radius_m)
VALUES (
  'sm-demo-san-miguel',
  'Supermercado Demo San Miguel',
  'San Miguel',
  'Calle San Nicolás 1033',
  -33.4988,
  -70.6551,
  250
);

INSERT OR IGNORE INTO user_supermarkets (user_rut, supermarket_id)
VALUES ('123456785', 'sm-demo-san-miguel');
`;
